    ...
    return (
        <main className="text-white w-full h-full py-1 flex flex-col gap-2">
            ...
            <form className="h-12 flex gap-2.5" onSubmit={handleSubmit(addUser)}>
                <input type="email" spellCheck='false' {...register('email')} className="peer w-full text-lg text-slate-200 bg-[#252525] border-2 border-[#3c3c3c] rounded-md invalid:border-pink-500 invalid:text-pink-600 focus:outline-none px-1"/>
